...
void setup() {
  ...
  Serial.println("LECTOR DE ENTRADAS -- Listo para usarse");
    ...
    if (piccType == MFRC522::PICC_TYPE_MIFARE_MINI || piccType == MFRC522::PICC_TYPE_MIFARE_1K || piccType == MFRC522::PICC_TYPE_MIFARE_4K) {
      ...
      if (!isSameCard || (millis() - lastReadTime >= readInterval)) {
        ...
        if (getLocalTime(&timeinfo)) {
          ...
          String requestBody = "{\"codigo_tarjeta\":\"" + DatoHex + "\",\"momento\":\"" + horaActual + "\",\"lector\":\"entrada\"}";
        ...
        Serial.println("La tarjeta ya ha sido ingresada previamente como una entrada. Espere 3 minutos para volver a ingresarla.");
      }
    }
  }
}
